          ...
          builder: (context, snapshot) {
            ...
            switch (snapshot.connectionState) {
              ...
              default:
                ...
                // DateTime dateOfBirthD = DateTime(int.parse(dateOfBirth[0]),
                //     int.parse(dateOfBirth[1]), int.parse(dateOfBirth[2]));
                // String age =
                //     ((DateTime.now().difference(dateOfBirthD).inDays / 365.25)
                //             .floor())
                //         .toString();
                ...
                int distance = geodesy
                    .distanceBetweenTwoGeoPoints(l1, LatLng(lg[0], lg[1]))
                    .toInt();
                return ListView(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          color: Colors.white,
                          boxShadow: [
                            BoxShadow(spreadRadius: .5, blurRadius: 7)
                          ],
                            ...
                            children: [
                              ...
                              Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                        onPressed: () {
                                          FlutterClipboard.copy(phone).then(
                                              (value) =>
