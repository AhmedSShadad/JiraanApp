...
class _AddPostAskState extends State<AddPostAsk> {
  ...
  void initState() {
    ...
    String age =
        ((DateTime.now().difference(dateOfBirth).inDays / 365.25).floor())
            .toString();
                          ...
                          if (_myDoc.docs[i]["index"] == "${_myDoc.size - 1}") {
                            ...
                            if (l.length <= 200) {
                              ...
                              askServicesUpdate(
                                      ...
                                      _jobController.text.trim().toString(),
                                      appState.getname,
                                      _postController.text.trim().toString(),
