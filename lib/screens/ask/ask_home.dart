...
class _AskHomeState extends State<AskHome> {
  ...
  Future GetData() async {
    ...
    QuerySnapshot _myDoc =
        await FirebaseFirestore.instance.collection('Ask').get();
    if (_myDoc.size > 0) {
      ...
      child: Column(
        children: [
                        ...
                        children: [
                          IconButton(
                              onPressed: () {
                                ...
                                ref.update({
                                  "data": FieldValue.arrayRemove([beforeAskMap])
                                }).then((value) {
                                  Navigator.pushReplacement(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => AskHome()));
                                });
                              },
                              icon: Icon(
                                Icons.delete,
          ...
          Row(
            ...
            children: [
              Text(
                appState.getlocal == "ar" ? 'الوظيفة :  ' : ' : Jop',
                textDirection: TextDirection.rtl,
                style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),
              ),
              Text(
