            ...
            children: <Widget>[
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => UserProfile(
                                      true,
                                      LatLng(appState.lat, appState.long),
                      ...
                      onPressed: () {
                        try {
                          FirebaseFirestore.instance
                            ...
                            appState.setChanges(
                                newabout:
                                    _controllerAbout.text.trim().toString());
                            setState(() {
                              EasyLoading.showSuccess("تم حفظ التغييرات بنجاح",
              ...
              Column(children: <Widget>[
                GestureDetector(
                    ...
                    child: customCard(
                        Icons.person, "الاسم كاملاً", appState.getname)),
                GestureDetector(
                    onTap: () {
                      _asyncChangesDialog(context, "رقم الهاتف", "phone");
                    },
                    child: customCard(
                        Icons.phone, "رقم الجوال", appState.getphone)),
                GestureDetector(
                    onTap: () {
              ...
              SliderTheme(
                ...
                child: Slider(
                  ...
                  max: 1,
                  value: _value == 0.01
                      ? _value = (double.parse(appState.getnearest) / 10)
                      : _value,
                  //value:  _value,
                  onChanged: (value) {
                    setState(() {
                    ...
                    onTap: () async {
                      ...
                      await _picker
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PhotoView(file)));
                      });
                    }),
                ListTile(
                  ...
                  onTap: () {
                    FirebaseFirestore.instance
                        ...
                        .update({
                      "image":
                          "", // "gs://jeraanapp-7f69a.appspot.com/391-3918613_personal-service-platform-person-icon-circle-png-transparent.png"
                    }).whenComplete(() {
                      appState.setChanges(
                          newimage:
                              "" //"gs://jeraanapp-7f69a.appspot.com/391-3918613_personal-service-platform-person-icon-circle-png-transparent.png"
                          );
                      EasyLoading.showSuccess("تم حذف الصورة بنجاح",
                          duration: Duration(milliseconds: 600));
                      Navigator.pop(context);
                    });
                  },
        ...
        return Directionality(
          ...
          child: AlertDialog(
            ...
            content: Form(
              ...
              child: TextFormField(
                style: TextStyle(
                    fontSize: 15, fontFamily: 'cairo', color: Colors.white),
                decoration: InputDecoration(
                  ...
                  labelStyle: TextStyle(
                      fontSize: 15, fontFamily: 'cairo', color: Colors.white),
                  hintStyle: TextStyle(
                      fontSize: 15, fontFamily: 'cairo', color: Colors.white60),
                    ...
                    setState(() {
                      if (_controller.text.trim().toString() != "") {
                        FirebaseFirestore.instance
                          ...
                          if (object == "name") {
                            appState.setChanges(
                                newname: _controller.text.trim().toString());
                          } else if (object == "phone") {
                            appState.setChanges(
                                newphone: _controller.text.trim().toString());
                          } else {
                            appState.setChanges(
                                newjop: _controller.text.trim().toString());
                          }
                        });
                      }
