...
class _UserProfileState extends State<UserProfile> {
  ...
  void initState() {
    try {
      ...
      int point =
          geodesy.distanceBetweenTwoGeoPoints(l1, widget.userlg).toInt();
      // DateTime dateOfBirth = DateTime(int.parse(appState.getage[0]),
      // int.parse(appState.getage[1]), int.parse(appState.getage[2]));
      // age = ((DateTime.now().difference(dateOfBirth).inDays / 365.25).floor())
      //     .toString();
      setState(() {
        distance = point;
      });
      ...
      body: Container(
        ...
        child: Column(
          children: [
            CircleAvatar(
              maxRadius: 45,
              backgroundImage: (appState.image == "" || appState.image == null)
                  ? AssetImage("images/profile.png")
                  : FirebaseImage(appState.image),
            ),
            SizedBox(
              height: 20,
            ),
            ...
            Column(
              children: [
                ...
                //       width: 5,
                //     ),
                //     // Text(appState.getlocal == "ar" ? "سنة" : "year",
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(appState.getlocal == "ar" ? "متر" : "m",
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          alignment: appState.getlocal == "ar"
                              ? Alignment.topRight
                              : Alignment.topLeft,
                          ...
                          child: Text(
                            appState.about,
                            style: TextStyle(fontSize: 14),
                            textAlign: appState.getlocal == "ar"
                                ? TextAlign.right
                                : TextAlign.left,
                          )),
                    ],
                ...
                Row(
                    ...
                    children: [
                      ...
                      IconButton(
                          onPressed: () {
                            FlutterClipboard.copy(appState.phone).then(
