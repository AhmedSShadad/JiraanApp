...
class EventDetails extends StatefulWidget {
  ...
  final String type;
  final String desc;
  EventDetails(this.image, this.name, this.id, this.distance, this.type,
      this.eventDate, this.desc);
  @override
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        appState.getlocal == "ar"
                                            ? 'شكرا علي الاهتمام بهذه المناسبة :)'
                                      ...
                                      child: TextButton(
                                        child: Text(
                                          appState.getlocal == "ar"
                                              ...
                                              : "Go to the advertiser's account and get the address and contact",
                                          style: TextStyle(
                                              fontSize:
                                                  appState.getlocal == "ar"
                                                      ? 15
