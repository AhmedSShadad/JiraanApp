...
class EditJob extends StatefulWidget {
  ...
  EditJob(this.image, this.name, this.hobby, this.desc, this.age, this.distance,
      this.id, this.docId, this.lat, this.long);
  @override
...
class _EditJobState extends State<EditJob> {
  ...
  final String id, docId;
  final double lat, long;
  _EditJobState(this.image, this.name, this.hobby, this.desc, this.age,
      this.distance, this.id, this.docId, this.lat, this.long);
                      ...
                      if (_titleController.text.trim() != "" &&
                        ...
                        try {
                          ...
                          if (_myDoc.size > 0) {
                            for (var i = 0; i < _myDoc.size; i++) {
                              ...
                              if (_myDoc.docs[i]["index"] ==
                                ...
                                if (l.length <= 200) {
                                  ...
                                  ref.update({
                                    "data":
                                        FieldValue.arrayRemove([beforeHobbyMap])
                                  });
                                  hobbyServicesUpdate(
                                          appState.getimage,
                                          appState.getname,
                            ...
                            ref.update({
                              "data": FieldValue.arrayRemove([beforeHobbyMap])
                            });
                            hobbyServicesSet(
                                    appState.getimage,
                                    appState.getname,
        ...
        return AlertDialog(
          ...
          content: Row(
            children: [
              ...
              Text(
                appState.getlocal == "ar"
                    ? 'تم تعديل الهواية بنجاح :)'
                    : 'Hobby Edited successfully :)',
                style: TextStyle(
