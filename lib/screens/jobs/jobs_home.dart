...
class _JobsHomeState extends State<JobsHome> {
            ...
            builder: (ctx) {
              return Container(
                ...
                child: TextButton(
                    ...
                    child: Text(
                      appState.getlocal == "ar" ? 'إضافة هواية' : "Add Hobby",
                      style: TextStyle(
                          fontSize: 20,
  ...
  Widget event(String image, String name, String hobby, String desc, String age,
      int distance, String id, String docId, double lat, double long) {
    AppState appState = Provider.of<AppState>(context, listen: false);
    return Container(
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => JobDetail(
                              image, name, id, distance, age, hobby, desc)));
                },
                child: Text(
                  appState.getlocal == "ar" ? 'عرض التفاصيل' : "View Details",
