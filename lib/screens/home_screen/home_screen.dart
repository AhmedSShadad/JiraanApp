...
class _HomeScreenState extends State<HomeScreen> {
          ...
          children: [
            Column(
              children: [
                ...
                Padding(
                  ...
                  child: DefaultButton(
                    text: appState.getlocal == "ar"
                        ? 'إضغط هنالاضافةالاعلان الخاص بك '
                        : 'Press here to add your own add',
                    press: () {
                      sendEmail();
                    },
                  ),
                ...
                Container(
                    margin: EdgeInsets.only(top: 12), child: HomeCarousel()),
  ...
  sendEmail() async {
    await launch("mailto:jiraanapp@gmail.com?subject=hello&body=New");
  }
}
