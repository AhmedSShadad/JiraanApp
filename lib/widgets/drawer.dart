          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                drawerCard(context, "images/user_6.png",
                    appState.getlocal == "ar" ? "ملفي الشخصي" : "Profile", 1),
                // drawerCard(context, "images/subscription.png", "نشاطي", 2),
                drawerCard(context, "images/youtube_2.png",
                    appState.getlocal == "ar" ? "الاعدادات" : "Settings", 3),
                drawerCard(context, "images/settings.png",
                    appState.getlocal == "ar" ? "عن التطبيق" : "About", 4),
                drawerCard(
                    context,
                    "images/logo_v_en_2.png",
                ...
                drawerCard(
                    context,
                    "images/logo_v_en_2.png",
                    appState.getlocal == "ar" ? "التواصل معنا" : "Contact us",
                    6),
                Container(
                    height: 80,
